 ...
 */
public class FragmentDoneUserTasks extends Fragment {
    ...
    View rootView;
    private String task_clicked= null;
    private SwipeRefreshLayout swipeContainer;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_done_user_tasks, container, false);
    ...
    void LoadData(){
        ...
        if(ParseUser.getCurrentUser().getObjectId().equals(groupID)){
            list = controller.getLocalTasksByManagerAndStatus(groupID, 3);
        }else{
            list = controller.getLocalTasksByUserAndStatus(ParseUser.getCurrentUser().getObjectId(), 3);
        }
    ...
    public void SaveOnParse(final Bitmap bitmap) {
