...
public class Task implements Comparable<Task>{
    ...
    // constructor
    public Task(String t_id, String m_id, String name, int priority, String location, String due_time, String assign,
    ...
    // constructor
    public Task(String m_id, String name, int priority, String location, String due_time, String assign,
                int accept, int status, String pic, String category) {
        _name = name;
        _priority=priority;
        _location=location;
